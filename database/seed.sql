...
(NULL, 'Void Data Chain', 'Chaîne chrome finition miroir, édition limitée Cyber Opulence.', 85.00, NULL, 1);
...
SELECT id, 10
FROM articles
WHERE name IN ('T-shirt KREED Shadow', 'Hoodie URBAN FOG', 'Void Data Chain');
